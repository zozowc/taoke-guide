...
(function () {
    ...
    app.innerHTML = `
      <div class="container">
        ...
        <div class="qr-wrapper">
          <img
            src="${escapeHtml(config.qr_image)}"
            alt=""
            id="qrImage"
  ...
  // --- Fallback copy (for older browsers / non-HTTPS) ---
    ...
    app.innerHTML = `
      <div class="container">
        <div class="error-state">
          ...
          <p>${escapeHtml(msg || '配置加载失败，请联系管理员')}</p>
        </div>
      </div>
    `;
  }
  ...
  function init() {
    ...
    fetch('config.json', { cache: 'no-cache' })
      ...
      .catch(function (err) {
        console.error('TaoKe-Guide load error:', err);
